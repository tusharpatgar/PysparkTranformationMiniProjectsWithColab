...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="  SIGN FUSION", font=("Times New Roman", 55, "bold"))
        ...
        self.speak.config(text="Speak", bg="blue", font=("Times New Roman", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=1205, y=630)
        self.clear.config(text="Clear",bg="#FF5733", font=("Times New Roman", 20), wraplength=100, command=self.clear_fun)
